...
void locateSphere(int b) {
    // Chaning these to an actual const byte array results in the lookup being loaded into a different location and with different alignment, all of whuch kills performance.
